...
namespace ImperatorToCK3.Helpers {
	public static class RakalyCaller {
		public static string ToPlainText(string savePath) {
			string executablePath = "Resources/rakaly-0.3.13-x86_64-pc-windows-msvc/rakaly.exe";
			if (RuntimeInformation.IsOSPlatform(OSPlatform.OSX)) {
				executablePath = "Resources/rakaly-0.3.13-x86_64-apple-darwin/rakaly";
			} else if (RuntimeInformation.IsOSPlatform(OSPlatform.Linux)) {
				executablePath = "Resources/rakaly-0.3.13-x86_64-unknown-linux-musl/rakaly";
			}
