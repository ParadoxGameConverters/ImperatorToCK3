...
namespace ImperatorToCK3.Imperator.Countries {
	...
	public class Country {
		...
		private SortedSet<string> monarchyLaws = new();
		private SortedSet<string> republicLaws = new();
		private SortedSet<string> tribalLaws = new();
		...
		private SortedSet<Provinces.Province> ownedProvinces = new();
